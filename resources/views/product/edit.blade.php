                  ...
                  <form role="form" action="{{route('products.update', ['product' => $product['id']])}}" method="post" enctype="multipart/form-data">
                    ...
                    @method('PUT')
                     <div class="form-group">
                      ...
                      <div class="col-md-8">
                        <input type="text" name="nama_produk" id="name" class="form-control" value="{{old('nama_produk')?old('nama_produk'):$product['nama_produk']}}">
                      </div>
                    </div>
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-md-8">
                        <input type="Number" name="stok" id="stok" class="form-control" value="{{old('stok')?old('stok'):$product['stok']}}">
                      </div>
                    </div>
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-md-8">
                        <input type="Number" name="harga" id="harga" class="form-control" value="{{old('harga')?old('harga'):$product['harga']}}">
                      </div>
                    </div>
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-md-8">
                        <textarea name="deksripsi" id="deksripsi" rows="3" class="form-control"></textarea>
                      </div>
                    </div>
                    <div class="form-group">
                      <div class="form-group">
